...
WholeTissueData_myeloid <- readRDS("/work/wjx/scRNA-seq/AIP/figure/figure5/WholeTissueData_macrophage_ident.rds.gz")

a <- list(WholeTissueData_B,WholeTissueData_myeloid)

names(a) <- c("Bcell", "Myeloid")
...
library(ComplexHeatmap)
pdf("Figure3e.pdf",width = 5,height = 4.7)
Heatmap(expr,
